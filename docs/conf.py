# -*- coding: utf-8 -*-
#
# stats_arrays documentation build configuration file, created by
# sphinx-quickstart on Thu Jun 13 09:08:22 2013.
#
...
htmlhelp_basename = 'stats_arraysdoc'
...
latex_documents = [
  ('index', 'stats_arrays.tex', u'stats\\_arrays Documentation',
...
man_pages = [
    ('index', 'stats_arrays', u'stats_arrays Documentation',
     [u'Chris Mutel'], 1)
]
...
texinfo_documents = [
  ('index', 'stats_arrays', u'stats_arrays Documentation',
   u'Chris Mutel', 'stats_arrays', 'One line description of project.',
   'Miscellaneous'),
]
